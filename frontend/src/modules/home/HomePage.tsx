  ...
  return (
    <div className="home-page">
      ...
      <section className="home-page__hero">
        <div className="home-page__hero-inner">
          ...
          <div className="home-page__hero-visual" aria-hidden>
            <img src={banners && banners.length ? banners[0].imageUrl : img.heroRing} alt="" />
          </div>
        </div>
      </section>

      <section id="featured" className="home-page__section home-page__featured">
      ...
      <section id="heritage" className="home-page__heritage">
        ...
        <a href="#collections" className="home-page__heritage-link">Read more</a>
      </section>
      ...
      <section className="home-page__section home-page__bts">
        <div className="home-page__section-head">
          ...
          <a href="#footer-newsletter" className="home-page__text-link">Follow us</a>
        </div>
